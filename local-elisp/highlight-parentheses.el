...
(defcustom hl-paren-idle-time 0.1
  "*Highlight parentheses idle time."
  :type 'integerp
  :group 'highlight-parentheses)
...
(defvar hl-paren-timer nil
  "hl-paren-highlight timer (alternate pos-command-hook.")
...
(define-minor-mode highlight-parentheses-mode
  ...
  (if highlight-parentheses-mode
      (progn
        ...
        (setq hl-paren-timer (run-with-idle-timer hl-paren-idle-time t 'hl-paren-highlight-timer-func)))
...
(defun hl-paren-highlight-timer-func ()
