...
;; Copyright (C) 2002-2007 by Stefan Kamphausen, Claus Brunzema
;; Authors:
;;           Stefan Kamphausen <http://www.skamphausen.de>
;;           Claus Brunzema    <mail< but not spam>@cbrunzema.de>
;; Keywords: services, user
(defvar highlight-context-version "1.6"
...
;; Main page:
;; http://www.skamphausen.de/cgi-bin/ska/highlight-context-line
...
;;; ChangeLog
;; 1.6   November 2007
;;       - Make the highlighted extend to the window border in Gnu
;;         Emacs
;;       - Fixed weblinks.
;;
;; 1.5   January  2003
...
(if (featurep 'xemacs)
  ...
  (defalias 'highlight-context-line-height 'window-body-height))
  ...
  (save-excursion
    ...
    (setq highlight-context-line-extent
          (highlight-context-line-make-extent
           (point-at-bol)
           (1+ (if (not (eq (point-at-bol) (point-at-eol)))
               (point-at-eol)
             (forward-line (- direct))
             (point-at-eol)))))
